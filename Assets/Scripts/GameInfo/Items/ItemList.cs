...
public class ItemList
{
	...
	public static Equipment woodenSword = new Equipment("Wooden Sword", 0, 0, 0, 10, 10, 0, 0, 0, 0, 0, 0);
	public static Equipment excalibur = new Equipment("Excalibur", 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 0);
}
